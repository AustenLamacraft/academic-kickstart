...
{{< figure src="NodalSurfaces.png" title="Three particle problem as a 3D wavefunction." numbered="true" lightbox="true" >}}
...
{{< figure src="ScatteringGeometry.png" title="Momentum space geometry of three particle scattering." numbered="true" lightbox="true" >}}
...
{{< figure src="mirrors.png" title="Three particle scattering as a 2D 'kaleidoscope', with the different sectors corresponding to different orderings of the particles." numbered="true" lightbox="true" >}}
...
{{< figure src="allrays.png" title="The six possible 'rays' related by reflections from the surfaces." numbered="true" lightbox="true" >}}
...
{{< figure src="2rays.png" title="Two ways for a ray to scatter from $(k_1,k_2,k_3)$ to $(k_3,k_2,k_1)$. The phases acquired must match if the Bethe ansatz is to work." numbered="true" lightbox="true" >}}
...
> Confirm that $c\to\infty$ reproduces the result of [Lecture 1]({{< ref "many-body-wavefunctions/#impenetrable-bose-gas" >}}) on the impenetrable Bose gas.
...
{{< figure src="LL_EnergyDensity.gif" title="Energy density as a function of $\gamma = c/n$. From [Lieb and Liniger (1963)](https://journals.aps.org/pr/abstract/10.1103/PhysRev.130.1605)." numbered="true" lightbox="true" >}}
...
> Finding $\bar N_k$ is not straightforward for wavefunctions that are not product states of momentum eigenstates. For this reason it's useful to refer to the $k_j$ in the Bethe wavefunction as __quasimomenta__.
> Note that $P_\text{tot}$ is, however, the true total momentum!
...
{{< figure src="PiShiftTypeII.png" title="Shifts relative to the $N=8$ ground state for the $N=7$ type II excitation." numbered="true" lightbox="true" >}}
...
{{< figure src="LL_TypeI+II.gif" title="Type I and II modes. From [Lieb (1963)](https://journals.aps.org/pr/abstract/10.1103/PhysRev.130.1616)" numbered="true" lightbox="true" >}}
